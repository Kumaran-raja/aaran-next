<div class="font-roboto tracking-wider my-16 flex-col flex gap-y-6">
    ...
    <div class="sm:w-9/12 w-auto mx-auto sm:px-0 px-2">
        <x-Ui::accordion.accordion :heading="'Is the subscription fee refundable?'">
        ...
        <x-Ui::accordion.accordion :heading="'Can I transfer my subscription to another business?'">
        ...
        <x-Ui::accordion.accordion :heading="'How many users can I add as managers to my business? '">
        ...
        <x-Ui::accordion.accordion :heading="'Will the prices be increased in the future?'">
            <div class="bg-gray-50 p-4 rounded-md text-xs">Yes. Incase prices increase, your current plan will be
                carried forward for you.
            </div>
        </x-Ui::accordion.accordion>
        <x-Ui::accordion.accordion :heading="'What happens to my data when I want to leave?'">
        ...
        <x-Ui::accordion.accordion :heading="'What happens if I want to downgrade to the free plan later?'">
        ...
        <x-Ui::accordion.accordion :heading="'I need more help.'">
